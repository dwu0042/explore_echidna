...
def create_sim(converter, parameters, seeds=0, numinfperseed=0, dt=1.0, track_movement=True):
...
def run_sims(n_reps=20):
    ...
    sim = create_sim(converter, parameters=parameters)
    ...
    for _ in range(n_reps):
        for i,v in enumerate(converter.ordering.sizes):
            ...
            outname = f"zero_sims/static/noselfloop_sim_all.h5"
