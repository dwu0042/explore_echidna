...
\node at (48.0,-30.0) [draw,storage,minimum width=1.6 cm, minimum height=1.6 cm](ATHOME){home};
...
% indirect
\draw [in=90,out=0,-stealth,dashed](A0.338)to(ATHOME.113);
\draw [in=270,out=0,-stealth,dashed](B0.23)to(ATHOME.248);
\draw [in=180,out=270,-stealth,dashed](ATHOME.293)to(B1.158);
\draw [in=180,out=90,-stealth,dashed](ATHOME.68)to(A1.203);
