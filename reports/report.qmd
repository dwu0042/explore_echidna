...
Victoria, Australia, has a population of 7.0 million people [@ABS_state_populations]. Its hospital system consists of more than 300 hospital campuses, which vary in size, case mix and services. 

Hospital admissions data was sourced from the Victorian Admitted Episdoes Dataset (VAED) [@VAED_official].
In particular, admissions data from [] to [] ([] days) was used in this study. All Victorian hospital admissions during this study period are included. The total number of admissions is []
